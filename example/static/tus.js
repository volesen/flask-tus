...
},{"url-parse":18}],5:[function(_dereq_,module,exports){
"use strict";
...
function checksum(chunk, callback) {
    ...
    fl.onloadend = function () {
        return callback(_sparkMd2.default.ArrayBuffer.hash(fl.result));
    };
}

},{"spark-md5":17}],9:[function(_dereq_,module,exports){
"use strict";
...
},{"./node/storage":6,"./upload":12}],12:[function(_dereq_,module,exports){
"use strict";
...
var _checksum = _dereq_("./checksum");
    ...
    value: function _startUpload() {
      ...
      if (this.options.uploadLengthDeferred) {
        ...
        this._source.slice(start, end, function (error, chunk) {
          ...
          // Calculate checksum
          if (_this5.options.checksum) {
            (0, _checksum2.default)(chunk, function (hash) {
              // Calculate and encode checksum. Set Upload-Checksum header
              xhr.setRequestHeader("Upload-Checksum", 'md5 ' + _jsBase.Base64.encode(hash));
              xhr.send(chunk);
            });
          } else {
            xhr.send(chunk);
...
},{"./checksum":8,"./error":9,"./fingerprint":10,"./node/request":4,"./node/source":5,"./node/storage":6,"extend":13,"js-base64":14}],13:[function(_dereq_,module,exports){
'use strict';
...
},{"querystringify":15,"requires-port":16}]},{},[11])(11)
});
